...
install_oci8() {
  ...
  local oracle_instant_client_dir="$1/.heroku/oracle_instantclient"
  ...
  mkdir -p $1/.profile.d
  echo "export LD_LIBRARY_PATH=\"\${HOME}/.heroku/oracle_instantclient:\$LD_LIBRARY_PATH\"" > $1/.profile.d/nodejs.sh
  echo "export OCI_LIB_DIR=\"\${HOME}/.heroku/oracle_instantclient\"" >> $1/.profile.d/nodejs.sh
  echo "export OCI_INC_DIR=\"\${HOME}/.heroku/oracle_instantclient/sdk/include\"" >> $1/.profile.d/nodejs.sh
  ...
  echo "$OCI_INC_DIR and $OCI_LIB_DIR"
